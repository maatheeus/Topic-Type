...
namespace EscolaLms\TopicTypes\Tests\APIs;
...
class CourseProgressApiTest extends TestCase
{
    ...
    public function testShowProgressCourse()
    {
    ...
    public function testShowProgressCourseFromGroup()
    {
        $user = User::factory()->create();
        $course = Course::factory()->create(['active' => true]);
        $lesson = Lesson::factory()->create(['course_id' => $course->getKey()]);
    ...
    public function testUpdateCourseProgress(): void
    {
        Mail::fake();
        Notification::fake();
        Queue::fake();
    ...
    public function testPingProgressCourse()
    {
        $user = User::factory()->create();
        $courses = Course::factory(5)->create(['active' => true]);
        $topics = Topic::factory(2)->create([
    ...
    public function testAddingNewTopicWillResetFinishedStatus(): void
    {
        Mail::fake();
        Notification::fake();
        Queue::fake();
